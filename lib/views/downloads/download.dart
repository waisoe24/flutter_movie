...
import 'package:flutter_news_homework/views/downloads/downlaod_look.dart';
import 'package:flutter_news_homework/views/downloads/download_movie.dart';
            ...
            children: [
                ...
                child: InkWell(
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (_) => DownloadMovie()));
                      //Navigator.pop(context,MaterialPageRoute(builder:(_) => Download()));

                    },
                    child: Container(

                      child: Text("Movies", style: TextStyle(fontSize: 30, ),)
                    )
                ),
              ),
              SizedBox(
              ...
              Container(
                child: InkWell(
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (_) => DownloadLook()));
                      //Navigator.pop(context,MaterialPageRoute(builder:(_) => Download()));

                    },
                    child: Container(
                        child: Text("Look", style: TextStyle(fontSize: 30, ),)
                    )
                ),
              ),
            ],
